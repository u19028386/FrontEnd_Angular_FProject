...
deleteQuestion(questionId: number) {
  ...
  getEmployeeTypes(): Observable<any>{
    return this.httpClient.get(`${this.apiUrl}MoTime/GetAllEmployeeTypes`).pipe(map(result => result));
  }
 ...
 // employees
  ...
  // }
 addEmployee(employee: Employee2): Observable<Employee2> {
    return this.httpClient.post<Employee2>(`${this.apiUrl}MoTime/AddEmployee`, employee, this.httpOptions);
  }
  ...
  // update
  editCalendarItem(calendarId: number,calendarItem : CalendarItem) {
    return this.httpClient.put(`${this.apiUrl}MoTime/EditCalendar/${calendarId}`, calendarItem, this.httpOptions);
  }
