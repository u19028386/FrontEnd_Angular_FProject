...
//   const value = control.value as number; // Cast the value to a number
...
//   styleUrls: ['./add-projectAllocation.component.scss']
// })
...
onEmployeeSelected(employee: any) {
  ...
  (this.projectAForm.get('employeeId') as FormControl).setValue(`${employee.pLastName} ${employee.pFirstName}`);
}
