...
// @Component({
//   selector: 'app-consolidated-project-report',
//   templateUrl: './consolidated-project-report.component.html',
//   styleUrls: ['./consolidated-project-report.component.scss'],
// })
...
//           widths: ['*'],
//           body: [
//             [{ text: report.projectName, style: 'projectHeader' }],
//           ],
//         },
//         layout: 'noBorders',
//         style: 'projectTable',
...
//               'Remaining Hours (%)',
//             ],
//             ...this.createTableContent(report), // Add employee data rows here
//             [
//               'Subtotal',
...
//       // Push the project and employee tables separately
//       pdfContent.push({ table: projectTable.table, layout: 'noBorders' });
//       pdfContent.push({ table: employeeTable.table, layout: 'noBorders' });
//     });
  
//     // Create the PDF definition
//     const pdfDefinition: TDocumentDefinitions = {
//       content: [
//         ...pdfContent, // Add your content here
//       ],
//       styles: {
//         projectHeader: {
//           fontSize: 16,
...
//     // Iterate through the consolidatedReport
//     this.consolidatedReport.forEach((report) => {
//       // Create content for each project
//       const projectContent: Content = [];
  
//       // Add project name
//       projectContent.push({ text: report.projectName, style: 'projectHeader' });
...
//       // Add employee data
//       const employeeData: Content[][] = this.createTableContent(report);
...
//       // Push all content for this project
//       projectContent.push(tableHeader, ...employeeData, subtotalRow);
  
//       // Push project content to the main PDF content
//       pdfContent.push({ table: { body: [projectContent] }, layout: 'noBorders' });
//     });
...
//   createTableContent(report: ConsolidatedReport): Content[][] {
...
//   private extractHTMLContent(element: HTMLElement): any[] {
//     const content: any[] = [];
